...
public class DataBase {
    ...
    private static final String DATABASE_CREATE =
        "create table table1(_id integer primary key autoincrement , "+ "cat text not null)";
   ...
   //---insert a title into the database---
    public long insertval(int _id,String cat) 
    {
    ...
    public boolean updateTitle(long rowId, String cat)
